var storefrontApp = angular.module('storefrontApp', ['gridster', 'ui.bootstrap']);

storefrontApp.controller('TestController', ['$scope', function ($scope) {
    $scope.testValue = 5;
...
storefrontApp.directive('vaTabs', function () {
    return {
        restrict: 'A',
...
storefrontApp.controller('DatepickerDemoCtrl', function ($scope) {
    // datepicker
    $scope.datepickers = {
        bd: false
    }
...
storefrontApp.controller('gridsterController', ['$scope', function ($scope) {
    $scope.chartObject = {
        "type": "ColumnChart",
        "displayed": true,
        "data": {
...
storefrontApp.directive('vaNumber', function ($compile, $timeout) {
        return {
            restrict: 'A',
            scope: {
                min: '=',
