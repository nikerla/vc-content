var Blade = {
    ...
    settings: function() {
        ...
        var newUrl = url.lastIndexOf('guides');
        newUrl = newUrl == -1 ? url.length : newUrl-1;
        url = url.substring(0, newUrl);
        $('#tplblade').load(url + '/themes/assets/guides/templates/settings/blade.html', function () {
            Blade.saveCode();
        });
        ...
        $('#result').load(url + '/themes/assets/guides/templates/settings/blade-error.html', function () {
            tplBladeError = $('#result').html();
        });

        $('#result').load(url + '/themes/assets/guides/templates/settings/blade-progress.html', function () {
            tplBladeProgress = $('#result').html();
        });

        $('#result').load(url + '/themes/assets/guides/templates/settings/blade-nav.html', function () {
            tblBladeNav = $('#result').html();
        });

        $('#result').load(url + '/themes/assets/guides/templates/settings/blade-icon.html', function () {
            tplBladeIcon = $('#result').html();
        });

        $('#result').load(url + '/themes/assets/guides/templates/settings/blade-title.html', function () {
            tplBladeTitle = $('#result').html();
        });

        $('#result').load(url + '/themes/assets/guides/templates/settings/blade-descr.html', function () {
            tplBladeDescr = $('#result').html();
        });

        $('#result').load(url + '/themes/assets/guides/templates/settings/blade-toolbar.html', function () {
            tplBladeToolbar = $('#result').html();
        });

        $('#result').load(url + '/themes/assets/guides/templates/settings/blade-content.html', function () {
            tplBladeContent = $('#result').html();
        });

        $('#result').load(url + '/themes/assets/guides/templates/settings/blade-static-top.html', function () {
            tplBladeStaticTop = $('#result').html();
        });

        $('#result').load(url + '/themes/assets/guides/templates/settings/blade-breadcrumbs.html', function () {
            tplBladeBreadcrumbs = $('#result').html();
        });

        $('#result').load(url + '/themes/assets/guides/templates/settings/blade-search.html', function () {
            tplBladeSearch = $('#result').html();
        });

        $('#result').load(url + '/themes/assets/guides/templates/settings/blade-search-solo.html', function () {
            tplBladeSearchSolo = $('#result').html();
        });

        $('#result').load(url + '/themes/assets/guides/templates/settings/blade-search-count.html', function () {
            tplBladeSearchCount = $('#result').html();
        });

        $('#result').load(url + '/themes/assets/guides/templates/settings/blade-static-bottom.html', function () {
            tplBladeStaticBot = $('#result').html();
        });

        $('#result').load(url + '/themes/assets/guides/templates/settings/blade-button.html', function () {
            tplBladeStaticButton = $('#result').html();
        });

        $('#result').load(url + '/themes/assets/guides/templates/settings/blade-table.html', function () {
            tplBladeTable = $('#result').html();
        });

        $('#result').load(url + '/themes/assets/guides/templates/settings/blade-list.html', function () {
            tplBladeList = $('#result').html();
        });

        $('#result').load(url + '/themes/assets/guides/templates/settings/blade-widgets.html', function () {
