...
<div class="business-features clearfix __responsive">
    ...
    <div class="business-cnt">
        ...
        <p class="text">
        Having the must-have features covered, let’s move on to looking at the most widely-used shopping carts out there. 
        </p>
        <h2>Shopify</h2>
        </div>
        <img alt="hosted shopping cart" src="assets/images/shopify.jpg"></img>
        <p class="text">
        ...
        <img alt="hosted shopping cart" src="assets/images/open-cart.jpg"></img>
        <p class="text">
        ...
        <img alt="hosted shopping cart" src="assets/images/pinnacle-cart.jpg"></img>
        <p class="text">
        ...
        <img alt="hosted shopping cart" src="assets/images/ultra-cart.jpg"></img>
        <p class="text">
        ...
        <img alt="hosted shopping cart" src="assets/images/magento.jpg"></img>
        <p class="text">
        ...
        <img alt="hosted shopping cart" src="assets/images/store-front.jpg"></img>
        <p class="text">
        ...
        <img alt="hosted shopping cart" src="assets/images/shop-integrator.jpg"></img>
        <p class="text">
        ...
        <img alt="hosted shopping cart" src="assets/images/yahoo-merchant-solutions.jpg"></img>
        <p class="text">
        ...
        <img alt="hosted shopping cart" src="assets/images/virto-commerce.jpg"></img>
        <p class="text">
