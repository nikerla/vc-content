...
<section itemscope itemtype="http://schema.org/Article">
    ...
    <div itemprop="articleBody" class="business-cnt" itemprop="mainContentOfPage">
        <div itemprop="mainEntityOfPage" class="head __cart">
            <h1 itemprop="headline" class="title">What is business to business e commerce? B2B e-commerce examples</h1>
        </div>
        ...
        {% include 'micro-mark-rating', bestRating: 5, ratingValue: 4.8, ratingCount: 1285 %}
        <div class="buttons">
