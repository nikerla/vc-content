...
<div class="business-cnt">
    ...
    <h2>What is Purchase Order Request Form?</h2>
    ...
    <h2>Use of Purchase Order on the Supplier Side</h2>
    ...
    <h2>Purchase Order vs. Purchase Invoice</h2>
    ...
    <h2>Steps in Purchase Order Process </h2>
    ...
    <p class="text">After the completion of all the four steps of the purchase order process, the goods can be received and inspected. After that, the buyer receives a purchase invoice and completes the money transaction to the supplier. </p>
    <h2>Benefits of using a Purchase Order</h2>
