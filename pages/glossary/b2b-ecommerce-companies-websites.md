...
<div class="business-features clearfix __responsive">
    ...
    <div class="business-cnt">
      ...
      <p class="text">6. Certified e-commerce trust marks that prove the website's reliability when it comes to purchasing goods and services.</p>
        ...
        <img alt="Made-in-China B2B ecommerce company" src="assets/images/madeinChina.png"></img>
         <p class="text">
        ...
        <h3>Grainger</h3>
        <img alt="Grainger B2B ecommerce company" src="assets/images/Grainer.png"></img>
         <p class="text">
