...
<div class="business-features clearfix __responsive">
    ...
    <div class="business-cnt">
      ...
      <p class="text">6. Certified e-commerce trust marks that prove the website's reliability when it comes to purchasing goods and services.</p>
        ...
        <h3>Alibaba</h3>
        <img alt="B2B e commerce companies and websites" src="assets/images/Alibaba.png"></img>
         <p class="text">
        ...
        <img alt="B2B e commerce companies and websites" src="assets/images/madeinChina.png"></img>
         <p class="text">
         ...
         <h3>ThomasNet</h3>
         <img alt="B2B e commerce companies and websites" src="assets/images/ThomasNet.png"></img>
         <p class="text">
        ...
        <h3>Grainger</h3>
        <img alt="B2B e commerce companies and websites" src="assets/images/Grainer.png"></img>
         <p class="text">
        ...
        <h3>Quill.com</h3>
        <img alt="B2B e commerce companies and websites" src="assets/images/quill.png"></img>
         <p class="text">
