...
<div class="business-features clearfix __responsive">
    ...
    <div class="business-cnt">
      ...
      <p class="text">6. Certified e-commerce trust marks that prove the website's reliability when it comes to purchasing goods and services.</p>
        ...
        <h3>Alibaba</h3>
        <img alt="Alibaba B2B ecommerce website" src="assets/images/Alibaba.png"></img>
         <p class="text">
        ...
        <img alt="Made-in-China B2B ecommerce website" src="assets/images/madeinChina.png"></img>
         <p class="text">
         ...
         <h3>ThomasNet</h3>
         <img alt="ThomasNet B2B ecommerce website" src="assets/images/ThomasNet.png"></img>
         <p class="text">
         ...
         <h3>Trade Key</h3>
         <img alt="Trade Key B2B ecommerce website" src="assets/images/TradeKey1.png"></img>
         <p class="text">
        ...
        <img alt="MSC Industrial Supply Co B2B ecommerce website" src="assets/MSC.png"></img>
         <p class="text">
        ...
        <h3>Grainger</h3>
        <img alt="Grainger B2B ecommerce website" src="assets/images/Grainer.png"></img>
         <p class="text">
        ...
        <h3>Quill.com</h3>
        <img alt="Quill B2B ecommerce website" src="assets/images/quill.png"></img>
         <p class="text">
         ...
         <h3>Ferguson</h3>
         <img alt="Ferguson B2B ecommerce website" src="assets/images/Ferguson1.png"></img>
         <p class="text">
        ...
        <img alt="Thermo Fisher Scientific B2B ecommerce website" src="assets/images/TFS.png"></img>
         <p class="text">
