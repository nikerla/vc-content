...
<section itemscope itemtype="http://schema.org/Article">
    ...
    <div itemprop="articleBody" class="business-cnt">
        <div class="business-cnt" itemprop="mainContentOfPage">
            <div itemprop="headline" class="head __cart">
            ...
            <div class="col-w">
                ...
                <div class="col __col-30">
                    <div class="block" style="margin-left: 25px">
                        <div class="section-title-h3">Top 5 B2B challenges and solutions</div>
                        <p class="text">
            ...
            <div class="section-title-h3">Alibaba</div>
            ...
            <div class="section-title-h3">Made-in-China.com</div>
            ...
            <div class="section-title-h3">ThomasNet</div>
            ...
            {% include 'vc-b2b_b2c-banner' %}
            <div class="section-title-h3">Trade Key</div>
            ...
            <div class="section-title-h3">MSC Industrial Supply Co.</div>
            <img alt="MSC Industrial Supply Co B2B ecommerce site" src="assets/MSC.png"></img>
            <p class="text">
            ...
            <div class="section-title-h3">Grainger</div>
            <img alt="Grainger B2B e commerce company" src="assets/images/Grainer.png"></img>
            <p class="text">
            ...
            <div class="section-title-h3">Quill.com</div>
            <img alt="Quill B2B e commerce site" src="assets/images/quill.png"></img>
            <p class="text">
            ...
            {% include 'vc-b2b_b2c-banner' %}
            <div class="section-title-h3">Ferguson</div>
            ...
            <div class="section-title-h3">Medline.com</div>
            <img alt="Medline B2B ecommerce website" src="assets/images/Medline1.png"></img>
            <p class="text">
            ...
            <div class="section-title-h3">Thermo Fisher Scientific</div>
            ...
            {% include 'micro-mark-rating', bestRating: 5, ratingValue: 4.7, ratingCount: 1575 %}
            <div class="buttons">
