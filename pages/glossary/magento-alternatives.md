...
<section itemscope itemtype="http://schema.org/Article">
    ...
    <div itemprop="articleBody" class="business-cnt">
        <div itemprop="mainEntityOfPage" class="head __cart">
            <h1 itemprop="headline" class="title">Magento alternative. 8 best Magento competitors. The best alternatives to Magento in 2017-2018.</h1>
        </div>
        ...
        <div class="col-w">
            ...
            <div class="col __col-30">
                <span itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
                    <img itemprop="url contentUrl" alt="Magento Alternative - Virto Commerce" src="assets/images/virto-commerce.jpg" />
