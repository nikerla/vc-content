...
<section itemscope itemtype="http://schema.org/Article">
    ...
    <div itemprop="articleBody" class="business-cnt">
        ...
        <div class="col-w">
            <div class="col __col-30">
                <span itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
                    <img itemprop="url contentUrl" alt="Best E commerce platforms" src="assets/images/ecommerce-platforms.jpg" />
        ...
        <div class="section-title">Questions to ask yourself while choosing the best online store platform for your business</div>
        <div class="text">
        ...
        {% include 'vc-magento-banner' with current_url : 'glossary/best-ecommerce-platforms' %}
        <div class="section-title">Woocommerce</div>
        <div class="col-w">
            <div class="col __col-30">
        ...
        <div class="text">
            ...
            <p>Woocommerce website needs to be self-hosted, offering you a huge advantage of modifying your website, but requiring the use of your own servers, so it might be the best online store platform for your business, if you value full control over the convenience of SaaS.</p>
        </div>
        ...
        <div class="section-title">Gumroad</div>
        <div class="col-w">
            <div class="col __col-30">
        ...
        <div class="section-title">Storenvy</div>
        <div class="col-w">
            <div class="col __col-70 text" style="margin-top: 0; padding-right: 20px;">
        ...
        <div class="section-title">Jimdo</div>
        <div class="col-w">
            <div class="col __col-30">
        ...
        <div class="section-title">Squarespace</div>
        <div class="col-w">
            <div class="col __col-30">
        ...
        <div class="section-title">E-junkie</div>
        <div class="col-w">
            <div class="col __col-70 text" style="margin-top: 0; padding-right: 20px;">
        ...
        <div class="section-title">X-cart</div>
        <div class="col-w">
            <div class="col __col-30">
        ...
        {% include 'vc-magento-banner' with current_url : 'glossary/best-ecommerce-platforms' %}
        <div class="section-title">Foxycart</div>
        <div class="col-w">
            <div class="col __col-30">
        ...
        <div class="section-title">Digital commerce platform for your business - Conslusions</div>
