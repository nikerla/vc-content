...
Once you downloaded and installed VirtoCommerce SDK open the Projects Configurator to create new project **without** sample data. More on creating a project read in [SDK getting started](docs/vc113devguide/development-environment/sdk-getting-started) tutorial.
...
In this tutorial we will cover the import option of catalog data setup. For a complete import tutorial go to [Import tutorial](). Only steps to import Boutique catalog data will be described here.
...
> Also if gateway requires parameters, they should be added into the GatewayProperty table.
> <img src="../../../assets/images/image2013-11-25 17_17_56.png" />
> More details in the [Payment gateway](docs/vc113devguide/working-with-orders/payment-gateway) tutorial.
